...
Ніколи не записуйте ваші ключові фрази на папері або в (незашифрованому) файлі. Захищений паролем файл Excel – це не шифрування. Архів, захищений паролем – не є належним шифруванням. Використовуйте тільки надійні менеджери паролів для зберігання пасфраз, якщо це необхідно.
